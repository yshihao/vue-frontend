                ...
                <div class="text item containerstyle">
                    ...
                    >
                        ...
                        <el-form-item label="抓取策略" prop="imagePullPolicy">
                            <el-select
                                v-model="podForm.imagePullPolicy"
                                placeholder="请选择"
                            >
                                <el-option
                        ...
                        <el-form-item label="工作目录" prop="workingDir">
                            <el-input
                                v-model="podForm.workingDir"
                                placeholder="请输入工作目录"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="Command" prop="command">
                            <div
                                v-for="(item, index) in podForm.command"
                                :key="index"
                            >
                                <div style="margin-bottom:5px">
                                    <el-input
                                        v-model="podForm.command[index]"
                                        placeholder="command"
                                        style="width:200px;"
                                    ></el-input>
                                    <el-button
                        ...
                        <el-form-item label="Args" prop="args">
                            <div
                                v-for="(item, index) in podForm.args"
                                :key="index"
                            >
                                <div style="margin-bottom:5px">
                                    <el-input
                                        v-model="podForm.args[index]"
                        ...
                        <el-form-item label="Ports" prop="ports">
                            <div
                                v-for="(item, index) in podForm.ports"
                                :key="index"
                            >
                                <div style="margin-bottom:5px">
                                    <el-row
                        ...
                        <el-form-item label="环境变量">
                            <div
                                v-for="(item, index) in podForm.env"
                                :key="index"
                            >
                                <div style="margin-bottom:5px">
                                    <el-row
                            ...
                            <div
                                v-for="(item, index) in podForm.envFrom"
                                :key="index"
                            >
                                <div style="margin-bottom:15px">
                                    <el-select
                                        v-model="item.prefix"
                                        placeholder="将configMap导入环境变量"
                                    >
                                        <el-option
                                            v-for="item in []"
                                            :key="item.value"
                        ...
                        <el-form-item label="挂载点">
                            <div
                                v-for="(item, index) in podForm.volumeMount"
                                :key="index"
                            >
                                <div style="margin-bottom:5px">
                                    <el-row
                                    ...
                                    >
                                        ...
                                        <el-col :span="10">
                                            <el-input
                                                v-model="
                                                    item.subPath_subPathExpr
                                                "
                                                placeholder="subPath/subPathExpr"
                                            ></el-input>
                                        </el-col>
                                    </el-row>
                                    <el-button
                        ...
                        <el-form-item label="CPU" v-show="sourceRestrict">
                            <el-row :gutter="5">
                                <el-col :span="10">
                                    <el-input
                                        v-model="podForm.cpulimits.cpumin"
                                        placeholder="最小，如500m"
                                    ></el-input>
                                </el-col>
                                <el-col :span="10">
                                    <el-input
                                        v-model="podForm.cpulimits.cpumax"
                                        placeholder="最大，如1000m"
                                    ></el-input>
                                </el-col>
                            </el-row>
                        </el-form-item>
                        <el-form-item label="内存" v-show="sourceRestrict">
                            <el-row :gutter="5">
                                <el-col :span="10">
                                    <el-input
                                        v-model="podForm.memlimits.memmin"
                                        placeholder="最少，如200M"
                                    ></el-input>
                                </el-col>
                                <el-col :span="10">
                                    <el-input
                                        v-model="podForm.memlimits.memmax"
                                        placeholder="最大，如2G"
                                    ></el-input>
                                </el-col>
                            </el-row>
                        ...
                        <el-form-item>
                            <el-button
                                ...
                                v-show="!sourceRestrict"
                                @click="sourceRestrict = true"
                            >
                                资源限制
                            </el-button>
                        </el-form-item>
