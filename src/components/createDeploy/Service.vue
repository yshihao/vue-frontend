                    ...
                    <div class="text item ">
                        ...
                        <div class="podstyle" style="height:30%;">
                            <el-dialog :visible.sync="commentFormVisible">
                                ...
                                <div slot="footer" class="dialog-footer">
                                    <el-button
                                        @click="commentFormVisible = false"
                                    >
                                        取 消
                                    </el-button>
                                    <el-button
                        ...
                        <div class="podstyle" style="height:40%">
                            ...
                            >
                                ...
                                >
                                    <el-select
                                        v-model="sessionForm.sessionaffinity"
                                        placeholder="请选择"
                                        @change="
                                            selectValue(
                                                sessionForm.sessionaffinity
                                            )
                                        "
                                    >
                                        <el-option
                                ...
                                >
                                    <div
                                        v-for="index in ipCounter"
                                        :key="index"
                                    >
                                        <div style="margin-bottom:5px">
                                            <el-input
                                                v-model="
                                                    sessionForm.externalip[
                                                        index
                                                    ]
                                                "
                                                style="width:200px;"
